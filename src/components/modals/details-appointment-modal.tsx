                    ...
                    <DialogDescription>
                        ...
                        {appointment !== undefined &&
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="font-bold dark:text-white"> Doctor ID: </p> <span>{appointment.patientId}</span>
                                <p className="font-bold dark:text-white"> Doctor ID: </p> <span>{appointment.patient.name}</span>
                            </div>
                        }
                    </DialogDescription>
                </DialogHeader>
