...
export default function DoctorsList() {
    ...
    const getDoctors = async (page = 1, limit = 6, pagination = true) => {
        try {
            setIsLoading(true);
            const response = await fetch(`https://citasmedicasdash.netlify.app/api/doctor/doctors?page=${page}&limit=${limit}&pagination=${pagination}`)
    ...
    return (
        <section className="bg-slate-100/90 dark:bg-slate-600/95 w-[20.625rem] xl:w-[35rem] 2xl:w-[43.625rem] h-[41.375rem] xl:h-[42rem] 2xl:h-[50rem] rounded-md shadow-2xl shadow-slate-500 dark:shadow-slate-700 ml-8 md:ml-20">
            ...
            <div className="mt-7 mb-5 pb-3 xl:mt-10">
